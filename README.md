...
alpha. The current packaged target is Apple Silicon macOS. Linux desktop
support is now in development; see [Linux desktop development](docs/linux-desktop.md).
